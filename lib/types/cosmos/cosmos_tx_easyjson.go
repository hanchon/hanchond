...
func easyjsonE114f9b1DecodeGithubComHanchonViviLibTypesCosmos(in *jlexer.Lexer, out *TxRestResponseForEvents) {
	...
	for !in.IsDelim('}') {
		...
		switch key {
		case "tx_response":
			easyjsonE114f9b1Decode(in, &out.TxResponse)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjsonE114f9b1EncodeGithubComHanchonViviLibTypesCosmos(out *jwriter.Writer, in TxRestResponseForEvents) {
	...
	_ = first
	{
		...
		easyjsonE114f9b1Encode(out, in.TxResponse)
	}
	out.RawByte('}')
}
...
func easyjsonE114f9b1Encode(out *jwriter.Writer, in struct {
	Height string `json:"height"`
	Txhash string `json:"txhash"`
	Code   int    `json:"code"`
	Logs   []struct {
	...
	}
	{
		...
		if in.Logs == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v3, v4 := range in.Logs {
				...
				easyjsonE114f9b1Encode1(out, v4)
			}
			out.RawByte(']')
		}
	}
	...
	}
	{
		...
		if in.Events == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v5, v6 := range in.Events {
				...
				easyjsonE114f9b1Encode2(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonE114f9b1Decode2(in *jlexer.Lexer, out *struct {
	Type       string `json:"type"`
	Attributes []struct {
		Key   string `json:"key"`
		Value string `json:"value"`
...
func easyjsonE114f9b1Encode2(out *jwriter.Writer, in struct {
	Type       string `json:"type"`
	Attributes []struct {
		Key   string `json:"key"`
		Value string `json:"value"`
	...
	}
	{
		...
		if in.Attributes == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v8, v9 := range in.Attributes {
				...
				easyjsonE114f9b1Encode3(out, v9)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonE114f9b1Decode3(in *jlexer.Lexer, out *struct {
	Key   string `json:"key"`
	Value string `json:"value"`
	Index bool   `json:"index"`
}) {
...
func easyjsonE114f9b1Encode3(out *jwriter.Writer, in struct {
	Key   string `json:"key"`
	Value string `json:"value"`
	Index bool   `json:"index"`
}) {
...
func easyjsonE114f9b1Decode1(in *jlexer.Lexer, out *struct {
	MsgIndex int    `json:"msg_index"`
	Log      string `json:"log"`
	Events   []struct {
		Type       string `json:"type"`
		...
		case "events":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonE114f9b1Decode4(in, &v10)
...
func easyjsonE114f9b1Encode1(out *jwriter.Writer, in struct {
	MsgIndex int    `json:"msg_index"`
	Log      string `json:"log"`
	Events   []struct {
		Type       string `json:"type"`
	...
	}
	{
		...
		if in.Events == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v11, v12 := range in.Events {
				...
				easyjsonE114f9b1Encode4(out, v12)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonE114f9b1Decode4(in *jlexer.Lexer, out *struct {
	Type       string `json:"type"`
	Attributes []struct {
		Key   string `json:"key"`
		Value string `json:"value"`
		...
		case "attributes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonE114f9b1Decode5(in, &v13)
...
func easyjsonE114f9b1Encode4(out *jwriter.Writer, in struct {
	Type       string `json:"type"`
	Attributes []struct {
		Key   string `json:"key"`
		Value string `json:"value"`
	...
	}
	{
		...
		if in.Attributes == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v14, v15 := range in.Attributes {
				...
				easyjsonE114f9b1Encode5(out, v15)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonE114f9b1Decode5(in *jlexer.Lexer, out *struct {
	Key   string `json:"key"`
	Value string `json:"value"`
}) {
	isTopLevel := in.IsStart()
...
func easyjsonE114f9b1Encode5(out *jwriter.Writer, in struct {
	Key   string `json:"key"`
	Value string `json:"value"`
}) {
	out.RawByte('{')
